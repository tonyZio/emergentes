class EvaluacionForm extends HTMLElement {
  ...
  async handleFormSubmit(option, event) {
    ...
    const datosEvaluacion = {
      ...
      ComentariosObservaciones: this.shadowRoot.getElementById(
  ...
  async loadEmpleados(option, evaluacion) {
    try {
      ...
      if (response.ok) {
        ...
        const selectEvaluador = this.shadowRoot.getElementById("evaluador");
        ...
        empleados.forEach((empleado) => {
          ...
          if (isActualizar && evaluacion.Empleado._id === empleado._id) {
          ...
          selectEvaluador.appendChild(clonedOption);

          if (isActualizar && evaluacion.Evaluador._id === empleado._id) {
