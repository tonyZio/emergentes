class DepartamentoForm extends HTMLElement {
  ...
  async connectedCallback() {
    ...
    if (option === "actualizar") {
      ...
      if (departamentoId) {
        ...
        console.error(
          "No se proporcionó un ID de departamento para actualizar."
        );
      }
    } else {
  ...
  async handleFormSubmit(option, event) {
    ...
    const datosDepartamento = {
      NombreDepartamento:
        this.shadowRoot.getElementById("nombreDepartamento").value,
      DescripcionDepartamento: this.shadowRoot.getElementById(
    ...
    this.shadowRoot.innerHTML = `
        ...
        <form action="" method="POST">
          ...
          <div style="display: flex; justify-content: space-between;">
            <input  id="cancel" type="cancel" value="Cancelar" >
            <input id="submit" type="submit" value="${
              isActualizar ? "Actualizar" : "Agregar"
            }">
          </div>
        </form>    
      `;
